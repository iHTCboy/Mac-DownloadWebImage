...
+ (void)alertWithWindow:(NSWindow *)aWindow type:(MLHudAlertType)type message:(NSString *)message {
    ...
    if (type == MLHudAlertTypeLoading) {
        ...
        [_staticHudAlert.loadingIndicator setContentFilters:[NSArray arrayWithObjects:lighten, nil]];
        //[_staticHudAlert.loadingIndicator.layer setBackgroundColor:[NSColor whiteColor].CGColor];
